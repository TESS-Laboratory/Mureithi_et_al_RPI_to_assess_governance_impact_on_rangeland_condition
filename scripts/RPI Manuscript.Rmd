...
Tweaked.Kenya.RPI.Rsquare.Plot <- ggplot(Kenya.Values.RPI.Rsquare, 
                                aes(x = RSQ, y = RPI)) +
  
  # Hexbin density
  geom_hex(bins = 60) +
  
  # ✅ Use correct viridis option
  scale_fill_viridis_c(
    option = "A",          # "A" = magma palette in viridisLite
    trans = "log10",
    name = "Pixel density"
  ) +
  ...
  # Labels + Theme
  labs(
    title = "Relationship Between RPI and Model Performance Across Kenya",
    subtitle = expression("Pixel-level relationship with threshold at " * R^2 == 0.1),
    x = expression(R^2 ~ "(Model performance)"),
    y = "Relative Productivity Index (RPI)"
  ) +
...
Tweaked.Kenya.RPI.Rsquare.Plot
```
