...
Africa.img <- grid::rasterGrob(png::readPNG("Africa_Map.png")) 
Conn.img <- grid::rasterGrob(png::readPNG("Connectivity_Map.png")) 
ConnFocus.img <- grid::rasterGrob(png::readPNG("Connectivity_Focus_Map.png")) 
...
Africa.Kenya.Connectivity.Final.Figure <- 
  ...
  plot_layout(widths = c(2, 2), heights = c(3, 3)) + 
...
#ggsave(
#  "Final_Figure.tiff",
#  plot = Africa.Kenya.Connectivity.Final.Figure,
#  width = 16,
#  height = 12,
#  dpi = 600,
#  compression = "lzw"
