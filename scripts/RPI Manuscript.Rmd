...
# convert the tmap grob below into a ggplot-compatible object using as.ggplot() from cowplot.
```
...
RPI.Ridgeline.Bottom.NoLegend <- ggplot(
  ...
  scale_fill_manual(
    values = area_colors_simulation[zones_bottom], # ensures correct colors
    drop = TRUE
  ) +
  labs(
    title = "Distribution of Mean Relative Productivity Index (RPI) by Area",
