...
pacman::p_load(sf, terra, tidyverse, tidyterra, colorspace, ggrepel, patchwork, tmap, trend, slider, forcats, viridis, viridisLite, scales, hexbin, ggh4x, scico, ggridges, truncnorm, zoo, cowplot, ggplotify)
...
Study.Areas.Map.Composite.Coloured <- tm_shape(All.Zones.Composite) +
  ...
  tm_layout(
    title = "Study Areas Distribution",
    legend.outside = TRUE,
