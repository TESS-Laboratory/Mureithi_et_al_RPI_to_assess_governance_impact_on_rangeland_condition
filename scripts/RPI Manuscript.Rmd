...
pacman::p_load(sf, terra, tidyverse, tidyterra, colorspace, ggrepel, patchwork, tmap, trend, slider, forcats, viridis, viridisLite, scales, hexbin, ggh4x, scico, ggridges, truncnorm, zoo, cowplot, ggplotify, png, magick)
...
```{r}
RPI.Ridgeline.Bottom.NoLegend

ggsave( filename = "RPI_Ridgeline_Bottom_NoLegend.png", plot = RPI.Ridgeline.Bottom.NoLegend, width = 8, height = 6, units = "in", dpi = 300 )
```
